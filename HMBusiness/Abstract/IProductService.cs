...
/*
 IDataResult ve IResult tanımlamamızdaki temel amaç uygulama için tanımlanan metotların yapmış olduğu işlemlerin başarılı olup olmamasını ve
    bununla ilgili bir mesaj döndürmesini istediğimiz için tanımladık. Bunların direkt metotların içesinde tanımlayabilirdik.
 Fakat bir metot sadece bir işlevi yapmalı(hem ürün döndürüp hem de yaptığı işlem ile ilgili mesaj döndürme ve durum sonucu döndürme işlemi yapmamalı.) o yüzden Utilities klasöründe 
